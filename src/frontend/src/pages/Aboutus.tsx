  ...
  return (
    <div className="about-us-container">
      ...
      <section className="about-us-section academic-section">
        ...
        <blockquote className="academic-quote">{t("aboutUs:aboutUs.academicQuote")}</blockquote>
      </section>
      ...
      <section className="about-us-section cta-section">
        ...
        <p className="cta-text">
          {t("aboutUs:aboutUs.quoteText")}

          <a className="link_ref" href="https://github.com/zemacedo99/Replication-Package-Builder">
            {t("aboutUs:aboutUs.quoteTextFinal")}
          </a>
        </p>
      </section>
    </div>
